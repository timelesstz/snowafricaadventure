  ...
  const routes = await Promise.all([
    prisma.trekkingRoute.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/49c04fa0-2704-4624-aaf4-59db6de1f1f5.jpg",
        gallery: [
          "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/49c04fa0-2704-4624-aaf4-59db6de1f1f5.jpg",
          "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/5317393539_b3ff8d1d93_k.jpg",
          "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/5-days-Marangu-route.jpg",
        ],
        isActive: true,
    ...
    prisma.trekkingRoute.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/5317393539_b3ff8d1d93_k.jpg",
        isActive: true,
        categoryId: categories[0].id,
      },
    }),
    prisma.trekkingRoute.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/5-days-Marangu-route.jpg",
        isActive: true,
        categoryId: categories[0].id,
      },
    }),
  ...
  const destinations = await Promise.all([
    prisma.destination.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/Serengeri-National-Park.jpg",
        isActive: true,
      },
    }),
    prisma.destination.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/Ngorongoro-conservation-area.jpg",
        isActive: true,
      },
    }),
    prisma.destination.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/Tarangire-National-Park.jpg",
        isActive: true,
      },
    }),
  ]);
  ...
  const dayTrips = await Promise.all([
    prisma.dayTrip.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/Day-trips.jpg",
        priceFrom: 120,
        isActive: true,
      },
    }),
    prisma.dayTrip.create({
      data: {
        ...
        featuredImage: "https://pub-cf9450d27ca744f1825d1e08b392f592.r2.dev/wp-content/uploads/2023/03/Arusha-National-Park-Day-trip.jpg",
        priceFrom: 180,
        isActive: true,
      },
    }),
