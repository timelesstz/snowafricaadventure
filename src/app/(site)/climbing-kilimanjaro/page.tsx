        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p className="text-[var(--text)] leading-[1.8]">
              Kilimanjaro stands 5,895 metres above sea level in northeastern Tanzania, inside <Link href="/mount-kilimanjaro/" className="text-[var(--secondary)] hover:underline">Kilimanjaro National Park</Link> — a UNESCO World Heritage Site. It is the highest mountain in Africa and the tallest free-standing mountain on Earth, meaning it rises directly from the surrounding plains rather than being part of a mountain range. The <Link href="/kilimanjaro-meaning-name-origin/" className="text-[var(--secondary)] hover:underline">name &quot;Kilimanjaro&quot;</Link> itself has debated origins, with theories ranging from Swahili to Chagga language roots. The summit, Uhuru Peak, sits on the rim of Kibo, an ancient volcanic crater that last erupted roughly 360,000 years ago.
            </p>
