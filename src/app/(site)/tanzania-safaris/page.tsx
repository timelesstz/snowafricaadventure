        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto prose prose-slate">
            ...
            <p>
              ...
              <Link href="/tanzania-destinations/ngorongoro-conservation-area/">Ngorongoro Crater</Link>, and
              the elephant-rich{" "}
