...
export default async function EditHeroPage({ params }: Props) {
  ...
  const hero = {
    ...
    imagePositionX: dbHero?.imagePositionX ?? 50,
    imagePositionY: dbHero?.imagePositionY ?? 50,
  ...
  async function saveHero(formData: FormData) {
    ...
    const data = {
      ...
      imagePositionX: parseInt(formData.get("imagePositionX") as string) || 50,
      imagePositionY: parseInt(formData.get("imagePositionY") as string) || 50,
