            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  name="highlights"
                  rows={6}
                  defaultValue={dayTrip?.highlights?.join("\n") || ""}
                  ...
                  placeholder="Visit stunning waterfalls&#10;Learn traditional coffee processing&#10;Meet local Chagga community"
                />
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    name="inclusions"
                    rows={8}
                    defaultValue={dayTrip?.inclusions?.join("\n") || ""}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none font-mono text-sm"
                    placeholder="Transport from Moshi/Arusha&#10;English-speaking guide&#10;Lunch&#10;Park fees"
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    name="exclusions"
                    rows={8}
                    defaultValue={dayTrip?.exclusions?.join("\n") || ""}
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none font-mono text-sm"
